...
import com.ejdash.esbn.Splash.CheckActivity.KakaoPayTest;
import com.ejdash.esbn.Splash.CheckActivity.LeftNavigationMenu;
...
//            signupId.setText("manadra");                      // 시연을 위해 미리 입력
    ...
    private void callLoginDialogAndMoveMainActivity() {
        ...
        login.setOnClickListener(v -> {
            getRedisKeyData();
//                DialogBlur dial = new DialogBlur(Splash.this);
