...
package com.ejdash.esbn.MainBottomNavigationTab.VOD;
...
import com.ejdash.esbn.MainBottomNavigationTab.VOD.VODAdapter.FragmentAdapter;
import com.ejdash.esbn.MainBottomNavigationTab.VOD.VODAdapter.FragmentSet;
...
public class VODFragment extends Fragment {
    ...
    public ArrayList<FragmentSet> VODList = new ArrayList<>();
    SwipeRefreshLayout VODListRefresh;
    RecyclerView VODRecyclerView;
    FragmentAdapter VODListAdapter;
...
//        LinearLayoutManager roomListLayoutSet = new LinearLayoutManager(context);
        ...
        VODListAdapter = new FragmentAdapter(VODList, context);
