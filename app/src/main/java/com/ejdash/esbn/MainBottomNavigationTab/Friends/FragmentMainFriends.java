...
import com.ejdash.esbn.MainBottomNavigationTab.Friends.Async.AsycnRequestFriendList;
import com.ejdash.esbn.MainBottomNavigationTab.Friends.FriendsAdapter.FragmentFriendAdapter;
import com.ejdash.esbn.MainBottomNavigationTab.Friends.FriendsAdapter.FragmentFriendSet;
...
public class FragmentMainFriends extends Fragment {
    public ArrayList<FragmentFriendSet> friendsList = new ArrayList<>();
    SwipeRefreshLayout friendsListRefresh;
    RecyclerView friendsRecyclerView;
    FragmentFriendAdapter friendsListAdapter;
    Handler mHandler;
    Unbinder unbinder;
...
//        Log.d(logTAG, "onCreate : CALL ");
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        friendsListAdapter = new FragmentFriendAdapter(friendsList, context);
        ...
        try {
            ...
            if (jsonElement.getAsJsonObject().get("count").getAsInt() > 0) {
                ...
                for (int i = 0; i < jsonElement.getAsJsonObject().get("result").getAsJsonArray().size(); i++) {
                    ...
                    FragmentFriendSet addItem = new FragmentFriendSet(
                            targetId,
                            sourceId,
                            targetIdThumbnail,
                            acceptState,
