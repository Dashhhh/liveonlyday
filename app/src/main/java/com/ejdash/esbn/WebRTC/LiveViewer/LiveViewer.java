package com.ejdash.esbn.WebRTC.LiveViewer;
...
import com.ejdash.esbn.WebRTC.LiveViewer.Async.AsyncGetMyPoint;
import com.ejdash.esbn.WebRTC.LiveViewer.Async.AsyncSendPointToStreamer;
import com.ejdash.esbn.WebRTC.LiveViewer.ChatRoomAdapter_Viewer.ChatRoomAdapterViewer;
import com.ejdash.esbn.WebRTC.LiveViewer.ChatRoomAdapter_Viewer.ChatRoomSetViewer;
import com.ejdash.esbn.WebRTC.WebRTCPeerManager.kurento.KurentoViewerRTCClient;
import com.ejdash.esbn.WebRTC.WebRTCPeerManager.kurento.models.CandidateModel;
import com.ejdash.esbn.WebRTC.WebRTCPeerManager.kurento.models.response.ServerResponse;
import com.ejdash.esbn.WebRTC.WebRTCPeerManager.kurento.models.response.TypeResponse;
...
public class LiveViewer extends AppCompatActivity
    ...
    private ChatRoomAdapterViewer chatRoomAdapterViewer;
    private ArrayList<ChatRoomSetViewer> chatRoomSetViewers = new ArrayList<>();
...
//            String receive = "Coming word : " + data;
            ...
            ChatRoomSetViewer setData = new ChatRoomSetViewer(
                    userType,
                    messageSendUserId,
                    chatText
                    );
    ...
    private void initChat() {
        ...
        chatRoomAdapterViewer = new ChatRoomAdapterViewer(chatRoomSetViewers, this);
...
//                jsonObject.put("presenterVODFilename", presenterVODFilename);
                ...
                ChatRoomSetViewer chatRoomSetViewer = new ChatRoomSetViewer(
                        "viewer",
                        "알림",
                        "채팅방에 입장했습니다!"
                );
