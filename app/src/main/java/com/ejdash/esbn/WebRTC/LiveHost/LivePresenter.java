package com.ejdash.esbn.WebRTC.LiveHost;
...
import com.ejdash.esbn.WebRTC.LiveHost.ChatRoomAdapter_Presenter.ChatRoomAdapterHost;
import com.ejdash.esbn.WebRTC.LiveHost.ChatRoomAdapter_Presenter.ChatRoomSetHost;
import com.ejdash.esbn.WebRTC.WebRTCPeerManager.kurento.KurentoPresenterRTCClient;
...
public class LivePresenter extends AppCompatActivity
    ...
    private Gson gson;
    private ChatRoomAdapterHost chatRoomAdapterPresenter;
    private ArrayList<ChatRoomSetHost> chatRoomSetPresenters = new ArrayList<>();
...
//            String receive = "Coming word : " + data;
            ...
            ChatRoomSetHost setData = new ChatRoomSetHost(
                    userType,
                    presenterSessionId,
                    chatText
            );
    ...
    */
    ...
    private void chatInit() {
        ...
        chatRoomAdapterPresenter = new ChatRoomAdapterHost(chatRoomSetPresenters, this);
    ...
    private void chatHandler(JSONObject chatInitMessage) {
        ...
        handler.postDelayed(() -> {
            try {
                ...
                ChatRoomSetHost chatRoomSetPresenter = new ChatRoomSetHost(
                        "presenter",
                        "알림",
                        "채팅방에 입장했습니다!"
                );
