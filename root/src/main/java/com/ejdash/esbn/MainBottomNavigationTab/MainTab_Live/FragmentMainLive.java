...
package com.ejdash.esbn.MainBottomNavigationTab.MainTab_Live;
...
import com.ejdash.esbn.MainBottomNavigationTab.MainTab_Live.LIVEAdapter.MainLiveFragmentAdapter;
import com.ejdash.esbn.MainBottomNavigationTab.MainTab_Live.LIVEAdapter.MainLiveFragmentSet;
...
public class FragmentMainLive extends Fragment {
    ...
    public ArrayList<MainLiveFragmentSet> roomList = new ArrayList<>();
    ...
    public FragmentMainLive() {
        // Required empty public constructor
    }

    public static FragmentMainLive newInstance() {
        Log.d("프래그확인", "newInstance : CALL ");
        FragmentMainLive fragment = new FragmentMainLive();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        roomListAdapter = new MainLiveFragmentAdapter(roomList, context);
    ...
    private void demoRoomList() {
        ...
        MainLiveFragmentSet addItem3 = new MainLiveFragmentSet(
                roomListRequest,
                parseFilename,
                parseUserName,
                parseTime,
        ...
        Log.i("방확인", "roomListRequest: " + roomListRequest);
        MainLiveFragmentSet addItem2 = new MainLiveFragmentSet(
                roomListRequest,
                parseFilename,
                parseUserName,
                parseTime,
        ...
        Log.i("방확인", "roomListRequest: " + roomListRequest);
        MainLiveFragmentSet addItem4 = new MainLiveFragmentSet(
                roomListRequest,
                parseFilename,
                parseUserName,
                parseTime,
