...
public class AsycnDenyAddingFriendsRequest extends AsyncTask<Void, Integer, JSONObject> {

    String sourceId;
    String targetId;


        public AsycnDenyAddingFriendsRequest(String sourceId, String targetId) {
        ...
        protected JSONObject doInBackground(Void... params) {
            ...
            try {
                ...
                Request request = new Request.Builder()
                        .url("http://13.124.128.18/esbn/friends/denyAddingFriendsRequest.php")
                        .post(formBody)
                        .build();
