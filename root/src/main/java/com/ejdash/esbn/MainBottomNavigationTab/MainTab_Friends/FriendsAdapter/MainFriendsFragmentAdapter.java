...
import com.ejdash.esbn.MainBottomNavigationTab.MainTab_Friends.Async.AsycnAgreeRequestForAddingFriends;
import com.ejdash.esbn.MainBottomNavigationTab.MainTab_Friends.Async.AsycnDenyAddingFriendsRequest;
 ...
 */
public class MainFriendsFragmentAdapter extends RecyclerView.Adapter<MainFriendsFragmentHolder> {

    private static final String TAG = "MainRoomFriendsList";
    ArrayList<MainFriendsFragmentSet> data = new ArrayList<>();
    Context mContext;

    public MainFriendsFragmentAdapter(ArrayList<MainFriendsFragmentSet> data, Context mContext) {
    ...
    @NonNull
    @Override
    public MainFriendsFragmentHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        TypefaceProvider.registerDefaultIconSets();
        View v = LayoutInflater.from(mContext).inflate(R.layout.adapter_friends_list, parent, false);
        return new MainFriendsFragmentHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull final MainFriendsFragmentHolder holder, int position) {
        final int i = position;

        MainFriendsFragmentSet getData = data.get(position);
