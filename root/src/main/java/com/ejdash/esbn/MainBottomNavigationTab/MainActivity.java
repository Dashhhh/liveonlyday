...
import com.ejdash.esbn.MainBottomNavigationTab.MainTab_Info.FragmentMainInfo;
import com.ejdash.esbn.MainBottomNavigationTab.MainTab_Live.FragmentMainLive;
import com.ejdash.esbn.MainBottomNavigationTab.MainTab_VOD.FragmentMainVOD;
import com.ejdash.esbn.R;
import com.ejdash.esbn.WebRTC.Live_Presenter.LivePresenter;
 ...
 *
 * @see FragmentMainLive
 * @see FragmentMainVOD
 * @see FragmentMainInfo
...
public class MainActivity extends AppCompatActivity
        implements
        FragmentMainInfo.OnFragmentInteractionListener,
        FragmentMainVOD.OnFragmentInteractionListener,
        FragmentMainLive.OnFragmentInteractionListener,
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_live:
                ...
                replaceFragment = new FragmentMainLive();

                break;
//                return loadFragment(replaceFragment);
            case R.id.action_vod:
                fab.setVisibility(View.GONE);
                replaceFragment = new FragmentMainVOD();

                break;
//                return loadFragment(replaceFragment);
            case R.id.action_info:
                fab.setVisibility(View.GONE);
                replaceFragment = new FragmentMainInfo();
                break;
//                return loadFragment(replaceFragment);
          /*
