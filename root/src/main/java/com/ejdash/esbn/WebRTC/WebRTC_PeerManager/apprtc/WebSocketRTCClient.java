...
package com.ejdash.esbn.WebRTC.WebRTC_PeerManager.apprtc;

import android.os.Handler;
import android.os.HandlerThread;
import android.util.Log;

import com.nhancv.webrtcpeer.rtc_comm.tcp.AsyncHttpURLConnection;
import com.nhancv.webrtcpeer.rtc_comm.tcp.WebSocketChannelClient;
...
public class WebSocketRTCClient implements AppRTCClient, WebSocketChannelClient.WebSocketChannelEvents {
    ...
    private void signalingParametersReady(final SignalingParameters signalingParameters) {
        ...
        events.onSignalConnected(signalingParameters);

        // Connect and register WebSocket client.
        wsClient.connect(signalingParameters.wssUrl, signalingParameters.wssPostUrl);
        wsClient.register(connectionParameters.roomId, signalingParameters.clientId);
        Log.i("룸확인", "connectionParameters.roomId : " + connectionParameters.roomId);
        Log.i("룸확인", "signalingParameters.clientId : " + signalingParameters.clientId);
    }
