...
public class AsyncRedisActiveUpCount extends AsyncTask<Void, Integer, JSONObject> {

    @SuppressLint("StaticFieldLeak")
    private Context mContext;
    private String userId;

    public AsyncRedisActiveUpCount(Context mContext) {
    ...
    protected JSONObject doInBackground(Void... params) {
        ...
        try {
            ...
            Request request = new Request.Builder()
                    .url("http://13.124.128.18/esbn/redis/loginZAdd.php")
                    .post(formBody)
                    .build();
